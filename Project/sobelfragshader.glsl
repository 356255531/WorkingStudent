...
void main(void) 
{
    ...
    vec4 x_gradient_3d =    -1.0 * bottom_left_color + -2.0 * bottom_color + -1.0 * bottom_right_color + 
                            1.0 * top_left_color + 2.0 * top_color + 1.0 * top_right_color;
    vec4 y_gradient_3d =    -1.0 * bottom_left_color + -2.0 * left_color + -1.0 * top_left_color +
